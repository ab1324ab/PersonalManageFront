                    ...
                    <Form inline v-model="imgObj">
                        ...
                        <FormItem style="margin-bottom: 0px">
                            <label class="filelabel" style="padding: 0px 15px;border: 0px" for="fileinput">
                                ...
                                <Icon type="md-image"></Icon>&nbsp;选择图片
                            </label>
                            <Button type="primary" @click="uploadImg('direct')" icon="md-cloud-upload">直接上传</Button>
                            <Button @click="handlecrop" type="primary" icon="md-crop">裁剪上传</Button>
                        </FormItem>
                    </Form>
                </Card>
